Consiste en interceptar una comunicación del cliente al AP, insertando en la data paquetes de des autenticación, con el objetivo de denegar el servicio al cliente.
